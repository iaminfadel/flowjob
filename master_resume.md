...
## Sparrow - Smart Agriculture Systems | Part-time Software Engineer | Cairo, Egypt | 2025-04 - Present
...
## ASU Racing Team - Formula Student AI UK | Formula AI Team Vice Captain | Cairo, Egypt | 2023-10 - 2024-08

### Context
ASU Racing Team autonomous racing division competing at Formula Student AI UK, engineering full-scale driverless race vehicles.
...
- Contributed to a 5th place finish at Formula Student AI UK in a prior season by developing core navigation and simulation systems, including reducing global raceline trajectory computation time from 151 seconds to 17 seconds — approximately a 90% improvement. [optimization, algorithms, navigation, trajectory-optimization, performance]
...
## ASU Racing Team - Formula Student AI UK | Navigation and Simulation Team Member | Cairo, Egypt | 2022-08 - 2023-10

### Context
Autonomous vehicle engineering team focused on path planning, trajectory optimization, and simulation environments for Formula Student AI UK.

### Achievements
- Contributed to a 5th place finish at Formula Student AI UK by developing core navigation and simulation systems for the autonomous race car. [autonomous-racing, navigation, simulation, formula-student]
- Reduced global raceline trajectory computation time from 151 seconds to 17 seconds through algorithmic optimization, enabling faster iteration during development and testing. [optimization, algorithms, raceline, performance, math]
...
- Designed and built an open-source, multi-agent AI pipeline saving candidates 15+ hours weekly across 100+ applications. [ai, python, agents, automation, system-design]
- Implemented robust browser automation with Playwright navigating Easy Apply forms across 50+ applications with zero CAPTCHA lockouts. [automation, playwright, web-scraping, browser-automation]
- Engineered an iterative evidence loop with 4 AI agents, boosting resume qualification match rate by 40%. [prompt-engineering, ats, llm, multi-agent]
...
## Lane Tracking System - Machathon 5.0 (1st Place) | Lead Computer Vision Developer | 2024 | https://github.com/iaminfadel
